                    ...
                    <div class="card-body">
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                            <label >Precio:</label>
                              <input type="number" onkeydown="if(event.key===','){event.preventDefault();}"  step="0.01"  class="form-control" id="price" name="price">
        ...
        <!-- Modal -->
        	<div class="modal left fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2">
        		<div class="modal-dialog" role="document">
                  ...
                  <h4 class="modal-title" id="myModalLabel2">Agregar Atributos</h4>
