                    ...
                    <div class="card-body">
                      ...
                      <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <td><input type="text" class="form-control"  name="inventory" value="<?=$edit_data[0]->inventory; ?>" ></td>
                          </div>
                      </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                            <label >Precio:</label>
                            <td><input type="text" class="form-control"  name="price" value="<?=$edit_data[0]->price; ?>"></td>
